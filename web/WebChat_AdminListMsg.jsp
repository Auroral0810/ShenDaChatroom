...
<div class="chat-container">
    ...
    <div class="message-list">
        ...
        <div class="message-item <%= isCurrentUser ? "current-user-message" : "other-user-message" %>">
            <div class="avatar">
                <%= isCurrentUser ? "管" :((username != null && username.length() > 0) ? username.substring(0, 1).toUpperCase() : "?")%>
            </div>
            <div class="message-content">
                <div class="message-header">
                    <span class="message-sender"><%= isCurrentUser ? username + " (管理员)" : username %></span>
                </div>
